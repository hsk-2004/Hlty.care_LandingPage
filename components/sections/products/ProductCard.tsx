    ...
    return (
        ...
        >
            <Link href="/description">
                ...
                <div className="relative w-full h-[180px] md:h-auto md:aspect-square overflow-hidden bg-[#5EE2A0] rounded-[7.2px] md:rounded-[16px] mb-1 md:mb-3 cursor-pointer">
                    <Image
                        src={product.image}
                        alt={product.name}
                        fill
            ...
            <div className="bg-white rounded-[7.2px] md:rounded-[16px] p-2 md:p-6 flex flex-col h-[138.2px] md:h-[293px] shadow-sm">
                <Link href="/description">
                    <h3 className="font-jubilat font-normal text-[12px] md:text-[20px] lg:text-[24px] text-[#183A39] mb-1 md:mb-3 leading-[1.0] md:leading-[1.1] cursor-pointer hover:opacity-70 transition-opacity">
                        {product.name}
                    </h3>
                </Link>
                ...
                <Link href="/description">
                    <p className="font-jubilat font-normal text-[8px] md:text-[13px] lg:text-[16px] text-[#183A39]/70 leading-[1.0] md:leading-[1.1] mb-2 md:mb-6 cursor-pointer hover:opacity-70 transition-opacity">
