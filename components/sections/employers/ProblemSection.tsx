    ...
    <section className="w-full bg-[#F0EEE6] py-16 lg:py-24">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 xl:px-24">
        ...
        <div className="hidden lg:grid lg:grid-cols-[1fr_auto_1fr] items-center gap-6 xl:gap-10">
          ...
          <div className="space-y-10 lg:pr-4 lg:-translate-y-20">
            <motion.h2 
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="font-jubilat text-[32px] md:text-[44px] lg:text-[36px] text-[#183A39] leading-[1.1] font-medium"
            >
          ...
          <div className="space-y-12 lg:space-y-6">
            {problems.map((item, idx) => (
              <motion.div
                ...
                className="space-y-3 lg:space-y-0.5"
              >
                <h3 className="font-haptik text-[14px] md:text-[15px] xl:text-[16px] text-[#183A39] font-bold uppercase tracking-[0.05em]">
                  {item.title}
                </h3>
                <p className="font-jubilat text-[13px] md:text-[14px] xl:text-[16px] text-[#183A39]/80 leading-relaxed lg:leading-[1.4]">
                  {item.description}
                </p>
              </motion.div>
            ))}
