    ...
    <section className="w-full bg-[#f2efe4] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="w-full mt-16 md:mt-24 lg:mt-32">
        <div className="flex flex-col items-center text-center space-y-8 px-4">
          <h2 className="font-jubilat text-[28px] md:text-[36px] lg:text-[44px] text-[#183A39] leading-tight font-medium max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 pt-2">
            {[
              ...
              <div 
                key={i} 
                className="px-6 py-3 rounded-full bg-[#183A39]/5 border border-[#183A39]/10 text-[#51D2A2] font-jubilat italic text-sm md:text-base whitespace-nowrap hover:bg-[#183A39]/10 transition-colors cursor-default"
              >
                {tag}
              </div>
            ))}
