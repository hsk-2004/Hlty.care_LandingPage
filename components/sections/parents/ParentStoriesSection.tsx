  ...
  return (
    <section className="w-full pb-20 pt-0 px-4 md:px-8 bg-[#F0EEE6]">
      <div className="max-w-[1290px] mx-auto">
        ...
        <div className="lg:flex lg:flex-col lg:items-stretch lg:justify-center gap-8 md:gap-12 lg:gap-12 mt-16 max-w-[1240px] mx-auto pb-24 overflow-visible px-6">
          {/* Green Box: Left Aligned for Desktop */}
          <div className="relative w-full lg:w-[740px] lg:h-[371px] flex justify-center lg:self-start lg:-rotate-[3.09deg]">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-14 lg:px-16 text-[#183A39] text-left pointer-events-none overflow-hidden">
              <h3 className="font-haptik font-bold text-[13px] md:text-[15px] lg:text-[16px] tracking-wider mb-1 md:mb-2">
                AROUND SLEEP
              </h3>
              <p className="font-haptik italic text-[12px] md:text-[16px] lg:text-[19px] leading-tight mb-2 md:mb-4">
                "Bedtime wasn't the problem, stimulation was."
              </p>
              <div className="font-haptik text-[10px] md:text-[13px] lg:text-[14px] leading-tight space-y-2 md:space-y-3">
                <p>
          ...
          <div className="relative w-full lg:w-[740px] lg:h-[411px] flex justify-center lg:self-end lg:rotate-[1.45deg]">
            <Image
          ...
          <div className="relative w-full lg:w-[740px] lg:h-[451px] flex justify-center lg:self-start lg:-rotate-[3.72deg]">
            <Image
