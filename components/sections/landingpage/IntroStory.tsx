    ...
    return (
        <section className="relative py-12 md:py-20 lg:py-32 px-6 bg-[#F0EEE6] overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl lg:max-w-5xl mx-auto flex flex-col items-center text-center">
                ...
                >
                    <p className="font-serif text-[12px] md:text-[18px] lg:text-[20px] leading-relaxed text-[#183A39] max-w-2xl lg:max-w-3xl mx-auto">
                    ...
                    <div className="space-y-2">
                        <h2 className="font-serif text-[20px] md:text-[40px] lg:text-[36px] text-[#183A39] leading-[1.1] font-normal">
                            But children don&apos;t live in warnings.
                        </h2>
                        <h2 className="font-serif text-[20px] md:text-[40px] lg:text-[36px] text-[#183A39] leading-[1.1] font-normal italic lg:whitespace-nowrap">
                            They live in <span className="text-[#3D8D7A]">stories</span>, <span className="text-[#B22222]">routines</span>, <span className="text-[#F3CA52]">play</span>, and <span className="text-[#1E40AF]">repetition</span>.
                        </h2>
                    </div>

                    {/* Bridge Text */}
                    <p className="font-serif text-[12px] md:text-[20px] lg:text-[20px] text-[#183A39]">
                        Hlty Beings exists to meet children there.
                    </p>

                    {/* Secondary Paragraphs */}
                    <div className="space-y-8 lg:space-y-12 font-serif text-[14px] md:text-[18px] lg:text-[20px] leading-[1.5] text-[#183A39] max-w-2xl lg:max-w-4xl mx-auto">
                        <p>
