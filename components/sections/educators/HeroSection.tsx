    ...
    <section className="w-full bg-[#f2efe4] pt-24 pb-12 lg:pt-32 lg:pb-24 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-20">
          ...
          >
            <div className="w-full lg:w-[709px] lg:h-[577px] aspect-[4/3] lg:aspect-auto rounded-[20px] overflow-hidden relative group shrink-0 shadow-sm border border-[#183A39]/10">
              <Image
