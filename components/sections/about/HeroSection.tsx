...
export default function HeroSection() {
  return (
    <section className="w-full px-0 md:px-6 lg:px-8 pt-0 pb-0">
      <div className="relative w-full max-w-[1306px] mx-auto overflow-hidden rounded-none md:rounded-[24px] shadow-sm">
        ...
        <div className="absolute inset-0 z-10 w-full flex flex-col items-center justify-start text-center px-4 pt-16 md:pt-12">
          <motion.div
