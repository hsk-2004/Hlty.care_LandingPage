...
export default function Footer({ hideTopDecoration = false }: FooterProps) {
    ...
    const socialIcons = [
        ...
        {
            name: "X",
            href: "https://x.com/hltybeings",
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.17l4.715 6.238L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
                </svg>
            ),
        },
    ];
                ...
                >
                    ...
                    <div className="flex flex-col items-start text-left space-y-12 max-w-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <h2 className="font-bitcountink text-[58px] md:text-[64px] lg:text-[85.81px] leading-none tracking-[-0.03em] whitespace-nowrap">
                                Hlty Bites
                            </h2>
