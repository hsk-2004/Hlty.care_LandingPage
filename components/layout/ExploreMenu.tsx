...
export default function ExploreMenu({ isOpen, onClose }: ExploreMenuProps) {
    return (
        <motion.div
            ...
            className={`fixed inset-0 bg-[#183A39] z-[120] overflow-y-auto ${isOpen ? "block" : "hidden"}`}
        >
            {/* Header Mirroring Navbar */}
            <div className="flex justify-between items-center p-4 lg:py-4 lg:px-24">
                ...
                <button 
                    onClick={onClose}
                    className="text-[#F0EEE6] p-1 hover:opacity-70 transition-opacity"
                >
